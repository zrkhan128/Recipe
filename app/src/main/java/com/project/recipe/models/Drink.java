package com.project.recipe.models;
...
public class Drink {
    ...
    public Drink(String id, String title, String instructions, String path, String alcoholic) {
        this.idDrink=id;
        this.strDrink=title;
        this.strInstructions=instructions;
        this.strDrinkThumb=path;
